...
class NovedadesNinosFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_novedades_ninos, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val exitButton = view.findViewById<ImageButton>(R.id.btnExitNewsNinos)
        ...
        val rvHombre = view.findViewById<RecyclerView>(R.id.rvTodasNovedadesNinos)
        ...
        adapter = RopaAdapter(data) { ropa ->
            ...
            activity?.let {
                ...
                it.supportFragmentManager.beginTransaction().addToBackStack(null)
                    .replace(R.id.containerNovedadesNinos, fragment).commit()
            }
        }
    ...
    private fun callGetRopaBySection() {
        val call = ApiRest.service.getByNuevoAndSection(true, "Ninos")
