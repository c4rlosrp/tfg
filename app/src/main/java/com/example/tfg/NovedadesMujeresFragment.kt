...
class NovedadesMujeresFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_novedades_mujeres, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val exitButton = view.findViewById<ImageButton>(R.id.btnExitNewsMujeres)
        ...
        val rvHombre = view.findViewById<RecyclerView>(R.id.rvTodasNovedadesMujeres)
        ...
        adapter = RopaAdapter(data) { ropa ->
            ...
            activity?.let {
                ...
                it.supportFragmentManager.beginTransaction().addToBackStack(null)
                    .replace(R.id.containerNovedadesMujeres, fragment).commit()
            }
        }
    ...
    private fun callGetRopaBySection() {
        val call = ApiRest.service.getByNuevoAndSection(true, "Mujer")
